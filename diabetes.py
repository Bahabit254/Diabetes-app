...
def main():
    ...
    if Button:
        ...
        with precision:
            st.metric(label="Precision Score", value="83.6%")
        with recall:
            st.metric(label="Recall Score", value="83.6%")
    
        with f1:
            st.metric(label="F1 Score", value="83.6%")
        with acc:
            st.metric(label="Accuracy Score", value="83.6%")
